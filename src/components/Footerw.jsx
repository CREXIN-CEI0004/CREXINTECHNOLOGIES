...
const Footerw = () => {
  return (
    ...
    <div className='foot1'>
    <div className='mail'><img src='images/18.png' /></div>
    <div style={{color:"white"}}>:info@crexin.com</div>
    ...
    <div className='pipes' style={{backgroundColor:"white"}}></div>
    ...
    <div className='call'>
    <div className='call1'><img src='images/19.png' style={{paddingTop:"6px"}}/></div>
    <div className='call2' style={{color:"white"}}>:+91-9059891091
    </div>
